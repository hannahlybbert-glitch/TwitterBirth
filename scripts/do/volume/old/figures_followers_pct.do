...
twoway ///
    ...
    title("Tweeting Behavior Pre/Post Birth (90pct followers)") ///
    graphregion(color(white)) ///
    xlabel(-78(13)78) ///
    legend(label(1 "> 90pct") label(2 "Others") position(2) ring(0))
* Save graph
graph export "$figures/twt_behavior/followers_pct/orig_90pct_followers.jpg", replace
restore
...
twoway ///
    ...
    ytitle("Avg Tweets per User") ///
    xtitle("Weeks from Birth") ///
    title("Tweeting Behavior Pre/Post Birth (>75pct followers)") ///
    graphregion(color(white)) ///
    xlabel(-78(13)78) ///
    legend(label(1 "> 75pct") label(2 "Others") position(2) ring(0))
* Save graph
graph export "$figures/twt_behavior/followers_pct/orig_75pct_followers.jpg", replace
restore
...
twoway ///
    ...
    ytitle("Avg Tweets per User") ///
    xtitle("Weeks from Birth") ///
    title("Tweeting Behavior Pre/Post Birth") ///
    graphregion(color(white)) ///
    xlabel(-78(13)78) ///
    legend(label(1 "> avg (7356)") label(2 "< avg") position(2) ring(0))
* Save graph
graph export "$figures/twt_behavior/followers_pct/orig_avg_split_followers.jpg", replace
restore
...
twoway ///
    ...
    ytitle("Avg Tweets per User") ///
    xtitle("Weeks from Birth") ///
    title("Tweeting Behavior Pre/Post Birth (10pct followers)") ///
    graphregion(color(white)) ///
    xlabel(-78(13)78) ///
    legend(label(1 "< 10pct") label(2 "Others") position(2) ring(0))
* Save graph
graph export "$figures/twt_behavior/followers_pct/orig_10pct_followers.jpg", replace
restore
...
twoway ///
    ...
    ytitle("Avg Tweets per User") ///
    xtitle("Weeks from Birth") ///
    title("Tweeting Behavior Pre/Post Birth (25pct followers)") ///
    graphregion(color(white)) ///
    xlabel(-78(13)78) ///
    legend(label(1 "< 25pct") label(2 "Others") position(2) ring(0))
* Save graph
graph export "$figures/twt_behavior/followers_pct/orig_25pct_followers.jpg", replace
restore
...
twoway ///
    ...
    ytitle("Avg Tweets per User") ///
    xtitle("Weeks from Birth") ///
    title("Tweeting Behavior Pre/Post Birth (10th vs 90th pct followers)") ///
    graphregion(color(white)) ///
    xlabel(-78(13)78) ///
    legend(label(1 "90th pct") label(2 "10th pct") position(2) ring(0))
* Save graph
graph export "$figures/twt_behavior/followers_pct/orig_90pct_10pct.jpg", replace
restore
...
twoway ///
    ...
    ytitle("Avg Tweets per User") ///
    xtitle("Weeks from Birth") ///
    title("Tweeting Behavior Pre/Post Birth (25th vs 75th pct followers)") ///
    graphregion(color(white)) ///
    xlabel(-78(13)78) ///
    legend(label(1 "75th pct") label(2 "25th pct") position(2) ring(0))
* Save graph
graph export "$figures/twt_behavior/followers_pct/orig_75pct_25pct.jpg", replace
restore
...
// **1. Original Tweet behavior (followers 90th percentile) 857 obs
// preserve
// collapse (mean) orig_qt_count, by(days_from_birth followers_90pct) 
// ** PLOT
// twoway ///
//     (line orig_qt_count days_from_birth if followers_90pct == 1, lcolor(red) lwidth(medthick)) ///
//     (line orig_qt_count days_from_birth if followers_90pct == 0, lcolor(gray) lwidth(medthick)), ///
//     xline(0, lpattern(dash) lcolor(edkblue)) ///
//     ytitle("Avg Tweets per User") ///
//     xtitle("Weeks from Birth") ///
//     title("Tweeting Behavior Before and After Birth (90pct followers)") ///
//     graphregion(color(white)) ///
//     xlabel(-78(13)78) ///
//     legend(label(1 "90pct") label(2 "Others") position(2) ring(0))
// * Save graph
// graph export "$figures/percentiles/orig_90pct_followers.jpg", replace
// restore
