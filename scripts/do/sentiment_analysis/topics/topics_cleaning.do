...
save "$sentiment/output/topic_sentiment_FULL_Karthik.dta", replace // main one we use for sentiment

export delimited using "$sentiment/output/topic_sentiment_FULL.csv", replace quote delimiter(",") nolabel
