...
* Created: 12/05/2025
* Purpose: Individual Fixed effects on Tweet Sentiment of Political
...
twoway ///
	...
	xline(0, lcolor(black)) ///
      ...
      ytitle("Estimated Effect on Sentiment of Political Tweets") ///
      title("FE Estimates of Tweet Sentiment from Political Tweets") ///
	  legend(order(1 4) label(1 "95% CI") label(4 "Baseline") position(2) ring(0)) ///
	  note("Note: Birth tweet excluded. Base month = -1" ///
	  "Analyzed on tweets where P(news & social concern) > 0.2, ~17% of all tweets from 4,011 accounts") 
graph export "$politics_figs/sentiment/fixed_effects/news_sentiment_FE.jpg", replace
restore
...
twoway ///
	...
	xline(0, lcolor(black)) ///
      xlabel(-18(2)18) ///
      xtitle("Months from Birth") ///
      ytitle("Estimated Effect on Positivity of Political Tweets") ///
      title("FE Estimates of Tweet Positivity of Political Tweets") ///
	  legend(order(1 4) label(1 "95% CI") label(4 "Baseline") position(2) ring(0)) ///
	  note("Note: Birth tweet excluded. Base month = -1" ///
	  "Analyzed on tweets where P(news & social concern) > 0.2, ~17% of all tweets from 4,011 accounts") 
graph export "$politics_figs/sentiment/fixed_effects/news_pos_FE.jpg", replace
restore
...
twoway ///
	...
	xline(0, lcolor(black)) ///
      xlabel(-18(2)18) ///
      xtitle("Months from Birth") ///
      ytitle("Estimated Effect on Negativity of Political Tweets") ///
      title("FE Estimates of Tweet Negativity of Political Tweets") ///
	  legend(order(1 4) label(1 "95% CI") label(4 "Baseline") position(2) ring(0)) ///
	  note("Note: Birth tweet excluded. Base month = -1" ///
	  "Analyzed on tweets where P(news & social concern) > 0.2, ~17% of all tweets from 4,011 accounts") 
graph export "$politics_figs/sentiment/fixed_effects/news_neg_FE.jpg", replace
restore
...
twoway ///
    ...
    title("FE Estimates of Tweet Sentiment of Political Tweets Around Birth by Gender", size(mlarge)) ///
	  note("Note: Birth tweet excluded. Base month = -1" ///
	  "Analyzed on tweets where P(news & social concern) > 0.2, ~17% of all tweets from 4,011 accounts." ///
	  "42% female, 58% male") ///
	legend(order(3 4 5) label(3 "Female") label(4 "Male") label(5 "Baseline") position(2) ring(0)) 	
	
graph export "$politics_figs/sentiment/fixed_effects/news_sent_FE_gender.jpg", replace
restore
...
twoway ///
    ...
    title("FE Estimates of Tweet Positivity of Political Tweets Around Birth by Gender", size(mlarge)) ///
	  note("Note: Birth tweet excluded. Base month = -1" ///
	  "Analyzed on tweets where P(news & social concern) > 0.2, ~17% of all tweets from 4,011 accounts." ///
	  "42% female, 58% male") ///
	legend(order(3 4 5) label(3 "Female") label(4 "Male") label(5 "Baseline") position(2) ring(0)) 	
	
graph export "$politics_figs/sentiment/fixed_effects/news_pos_FE_gender.jpg", replace
restore
...
twoway ///
    ...
    title("FE Estimates of Tweet Negativity of Political Tweets Around Birth by Gender", size(mlarge)) ///
	  note("Note: Birth tweet excluded. Base month = -1" ///
	  "Analyzed on tweets where P(news & social concern) > 0.2, ~17% of all tweets from 4,011 accounts." ///
	  "42% female, 58% male") ///
	legend(order(3 4 5) label(3 "Female") label(4 "Male") label(5 "Baseline") position(2) ring(0)) 	
	
graph export "$politics_figs/sentiment/fixed_effects/news_neg_FE_gender.jpg", replace
restore