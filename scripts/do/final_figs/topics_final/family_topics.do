...
* Created: 04/14/2026
* Updated: 04/14/2026
* Purpose: Event study (no fixed effects) of family topic probability — overall and by gender
...
preserve
	...
	* Insert baseline observation at month -1 so connected line passes through (−1, 0)
	...
	graph export "$topics_out/family_topics.$fig_format", replace
restore
...
preserve
	...
	* Insert baseline observation at month -1 so connected line passes through (−1, 0)
	...
	graph export "$topics_out/family_topics_gender.$fig_format", replace
restore
