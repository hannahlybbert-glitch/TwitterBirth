...
* Created: 02/20/2026
* Purpose: Fixed effects estimates of tweet positivity by gender
...
preserve
	...
	* Insert baseline observation at month -1 so connected line passes through (-1, 0)
	...
	twoway ///
		...
		$xlab_months ///
		$xtitle_months ///
		ytitle("Positivity", size($ytitle_size)) ///
		$ylab ///
		$leg_gender ///
		$region

	graph export "$sent_out/pos_fe_gender.$fig_format", replace
restore
