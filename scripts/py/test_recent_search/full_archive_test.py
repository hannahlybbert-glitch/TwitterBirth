...
# QUERIES = {
#     # Query 1: Structured birth announcements
#     1: '("welcome to the world baby" OR ("life update" "baby") OR "introducing baby" OR "our little one has arrived" OR "our new baby" OR "meet our baby" OR "our family just got bigger" OR "we had a baby" OR "our bundle of joy" OR "our baby is here" OR "we had our baby") -has:videos -is:retweet -is:quote -is:reply lang:en -puppy -cat -kitten -dog -"welcome to the world of" -"born again" -"chromosome" -"i was born" -dream -niece -nephew -granddaughter -grandchild -grandson -aunt -uncle',

#     # Query 2: Somewhat broad search
#     2: '(("born" "wife" "baby") OR ("born after" "labor" "hours") OR ("born" "pounds" "ounces") OR ("born" "lbs" "oz") OR ("mom and baby are") OR ("born" "c-section") OR ("say hello to baby") OR ("say hi to baby") OR ("born at" "AM") OR ("born at" "PM") OR ("born" "this morning") OR ("born at" "this morning") OR ("born at" "afternoon")) -has:videos -is:retweet -is:quote -is:reply lang:en -puppy -cat -kitten -dog -dream -niece -nephew -granddaughter -grandchild -grandson -aunt -uncle',

#     # Query 3: Family-centered birth phrases
#     3: '(("had my baby" "today") OR ("i gave birth" "ago") OR ("i gave birth" "today") OR ("i gave birth" "yesterday") OR ("i gave birth" "last night") OR "meet your baby brother" OR "meet your baby sister" OR "was born last night" OR "was born a few hours ago" OR "we are officially parents") -has:videos -is:retweet -is:quote -is:reply lang:en -puppy -cat -kitten -dog -dream -niece -nephew -granddaughter -grandchild -grandson -aunt -uncle',

#     # Query 4: Broad birth announcement phrases
#     4: '("welcomed our baby" OR ("i became a mother" "today") OR ("i became a father" "today") OR ("went into labor" "ago") OR "delivered naturally" OR "we had a baby girl" OR "we had a baby boy" OR "welcoming our newest blessing" OR "we became parents today" OR "baby finally arrived") -has:videos -is:retweet -is:quote -is:reply lang:en -puppy -cat -kitten -dog -dream -niece -nephew -granddaughter -grandchild -grandson -aunt -uncle',

#     # Query 5: Variations of "I had a baby"
#     5: '(("i had a baby" "ago") OR ("i had a baby" "today") OR ("i had a baby" "last night") OR ("i had a baby" "yesterday") OR ("i had a baby" "this morning") OR ("arrived" "baby" "wife") OR ("arrived" "baby" "husband")) -has:videos -is:retweet -is:quote -is:reply lang:en -puppy -cat -kitten -dog -dream -niece -nephew -granddaughter -grandchild -grandson -aunt -uncle'
# }

QUERIES = {
    # Query 1: Structured birth announcements (Explicit, well-formed statements) (with pictures)
    1: '("welcome to the world baby" OR ("life update" "baby") OR "introducing baby" OR "our little one has arrived" OR "our new baby" OR "meet our baby" OR "our family just got bigger" OR "we had a baby" OR "our bundle of joy" OR "our baby is here" OR "we had our baby") -has:links -has:videos -is:retweet -is:quote -is:reply lang:en -puppy -cat -kitten -dog -"welcome to the world of" -"born again" -"chromosome" -"i was born" -dream -niece -nephew -granddaughter -grandchild -grandson -aunt -uncle',
